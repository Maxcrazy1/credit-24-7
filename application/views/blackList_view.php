...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Lista Negra de Clientes <small><?//=$RegionInfo->reg_nombre?></small></h1>
  </section>
                ...
                <?php if ($loanListQ): ?>
                  ...
                  <tr>
                    ...
                    <?php if ($datediff >= 14+3):?>
                      <td class="bg-red"><?=$datediff-14?> Día(s)
                      <?php elseif ($datediff > 14): ?>
                        <td class="bg-yellow"><?=$datediff-14?> Día(s)
                        <?php else: ?>
                          <td> Sin Pendientes.
                          <?php endif ?>
                        </td>
